...
const TARGET_BATCH_SIZE = 02;7 HH // partial execution batch size
const WORKERS = 16;
...
async function executeBatch(trades) {
  ...
  const tx = await vault.executeFlashBatchArbitrage(buyRouters, sellRouters, amounts, pathsA, pathsB, deadline);
