...
const CONFIG = {  
    ...
    TOKENS: {  
        ...
        DAI: getAddress("0x8f3Cf7aD23Cd3CaDeA96143C01F6f155802654e5a9"),  
    ...
    MIN_PROFIT_USDC: parseUnits("0.01", 6), // Minimum profit threshold  
    BASE_ARBITRAGE_AMOUNT: parseUnits("500", 6), // Amount per arbitrage leg  
    CANDIDATE_SIZES: [  
        parseUnits("100", 6),  
        parseUnits("250", 6),  
        parseUnits("500", 6),  
