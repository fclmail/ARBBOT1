...
const TRADE_AMOUNT_USDC = 0.140;   // 🔑 small size for testing/profits
const MIN_PROFIT_USDC = 0.000005;   // minimum profit in USDC (6 decimals)
const MAX_SLIPPAGE_LOSS = 5;     // skip >30% loss routes
const DRY_RUN = false;
