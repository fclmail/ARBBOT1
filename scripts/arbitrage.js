...
const MIN_TRADE_USDC = Number(process.env.MIN_TRADE_USDC || 0.05);    // Don't trade < this USDC
...
// ---------- SCAN LOOP ----------
const TRADE_AMOUNT_USDC = Number(process.env.TRADE_AMOUNT_USDC || 0.07); // default small
