...
// ---------------------------------------------------------
//  ARBITRAGE BOT – VAULT VERSION (CRASH-SAFE)
//  - Continuous scan
//  - All tokens + routers preserved
//  - Vault custody enforced
//  - Never exits on revert (CI safe)
// ---------------------------------------------------------
...
const MIN_EXPECTED_PROFIT = 0.00001;   // must match vault (10 units)
