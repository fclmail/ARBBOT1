...
// Safety / tuning
const GAS_COST_USDC = Number(process.env.GAS_COST_USDC ?? "0.0005"); // conservative USDC buffer for gas & slippage
...
// Scan settings
const TRADE_AMOUNT_USDC = Number(process.env.TRADE_AMOUNT_USDC ?? ".03"); // human USDC
