...
const MIN_TRADE_USDC = .050;        // minimum trade size (USDC)
const MIN_EXPECTED_PROFIT = 0.001;  // minimum expected profit (USDC)
const MIN_PROFIT_PCT = 0.2;         // percent (e.g. 0.2% profit threshold)
const SLIPPAGE_PCT = 0.5;           // slippage tolerance applied to expectations
const MAX_PROFIT_PCT = 1000;        // sanity cap for absurd quoted profit %
